...
##
##==============================================================================
## Syntax - run from command line
##==============================================================================
## Rscript primer_blast_v1.R -h
## Rscript primer_blast_v1.R -i primer_blast_inputs.csv
## Rscript primer_blast_v1.R -i PATH/primer_blast_inputs.csv -o PATH/primer_blast_outputs.csv
## Rscript primer_blast_v1.R -v TRUE -i PATH/primer_blast_inputs.csv
##==============================================================================
...
suppressPackageStartupMessages(library("primerTree", quietly = TRUE))
suppressPackageStartupMessages(library("plyr", quietly = TRUE))
suppressPackageStartupMessages(library("seqinr", warn.conflicts = FALSE, quietly = TRUE))
...
option_list = list(
    ...
    make_option(c("-o", "--output"), type = "character", default = "primer_blast_outputs.csv",
...
## Submit primer pairs to Primer-Blast
